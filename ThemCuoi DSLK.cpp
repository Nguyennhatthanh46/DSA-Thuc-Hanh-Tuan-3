/*
Thêm một phần tử vào cuối danh sách liên kết đơn Cho một danh sách liên kết đơn, 
hãy cài đặt hàm SinglyLinkedListNode* insertNodeAtTail(int )  để thêm một nút có thuộc tính data có giá trị _data vào cuối danh sách liên kết đơn. 
